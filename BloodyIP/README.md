...
```
$ git clone git://github.com/Asare-Alex/Reversed-Engineering/BloodyIP.git
$ cd BloodyIP
$ bash bloody.sh
```
...
### Single Line Command
```
apt update ; apt install git ; git clone git://github.com/Asare-Alex/Reversed-Engineering/BloodyIP.git ; cd BloodyIP ; bash bloody.sh
```
